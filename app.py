...
# =================================================================
# 🖼️ THUMBNAIL JUDGE ONLY: Used only for the quick UI badge
# =================================================================
...
# =================================================================
# 🧠 THE PURE AI PROMPT: Gemini judges itself
# =================================================================
def build_prompt():
...
3. If a word has no price next to it, give it an amount of 0.0.
4. Act like a human: Evaluate the physical image and your own extraction. Provide two integer scores:
   - "image_readability_score" (0-100): How physically blurry, dark, or messy is the photo? (100 = perfectly clear print/scan, 40 = messy handwriting/bad lighting).
   - "ai_confidence_score" (0-100): How confident are you that you perfectly extracted the math and text without errors? (100 = absolute certainty, 50 = guessed a lot).
...
EXPECTED FORMAT EXACTLY:
{
  ...
  "items": [{"item": "Data", "amount": 10.0, "category": "Misc"}]
}"""
...
def build_calculations(parsed_data, source_type):
    ...
    # We now strictly pull the scores generated by the AI's internal logic
...
def analyze_image():
    # This route is purely for the instant UI thumbnail badge. It uses local math to save API calls.
    try:
